...
#create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 4} [get_ports { clk }];#set
...
## RGB LEDs
set_property -dict { PACKAGE_PIN L15    IOSTANDARD LVCMOS33 } [get_ports { LED_1 }]; #IO_L22N_T3_AD7P_35 Sch=LED4_B
